...
import { invert_theme_Ctx } from './invert_theme_b';
export interface invert_theme_class_Ctx extends invert_theme_Ctx {
    invert_theme_class?: invert_theme_class_T;
}
export declare const invert_theme_class_b: import("@ctx-core/object").Be<invert_theme_class_Ctx, "invert_theme_class">;
export declare type $invert_theme_class_T = string;
